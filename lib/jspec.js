// Class - Copyright TJ Holowaychuk <tj@vision-media.ca> (MIT Licensed)
...
;(function(){
  ...
  var Suite = Class({
    ...
    init: function(description, body) {
  ...
  var Assertion = Class({
    ...
    init: function(matcher, actual, expected, negate) {
    ...
    run : function() {
      ...
      this.expected.unshift(actual)
      this.result = this.matcher.match.apply(this, this.expected)
      this.passed = this.negate ? !this.result : this.result
      if (!this.passed) this.message = this.matcher.message.call(this, this.actual, this.expected, this.negate, this.matcher.name)
      return this
    }
  })
  ...
  var ProxyAssertion = Assertion.extend({
    calls: [],
    defer: true,
    
    init: function(object, method, times, negate) {
      var self = this
      this.object = object
      this.method = method
      this.negate = negate
      this.old = object[method]
