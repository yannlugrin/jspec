...
;(function(){
  ...
  JSpec = {
    ...
    runSuite : function(suite) {
      ...
      queue.insert(this, 'hook', 'beforeSuite', suite)
      suite.hook('before', queue)
      suite.hook('before_nested', queue)
      each(suite.specs, function(spec) {
        queue.insert(JSpec, 'hook', 'beforeSpec', spec)
        suite.hook('before_each', queue)
        queue.insert(JSpec, 'runSpec', spec)
        suite.hook('after_each', queue)
        queue.insert(JSpec, 'hook', 'afterSpec', spec)
      })
      if (suite.hasSuites()) {
      ...
      queue.insert(this, 'hook', 'afterSuite', suite)
